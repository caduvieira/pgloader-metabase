...
DROP TABLE IF EXISTS public.indicadores_dimensao;

CREATE TABLE public.indicadores_dimensao
(
    ...
    CONSTRAINT indicadores_dimensao_pkey PRIMARY KEY (protocolo, nota, cod_ciclo, cod_etapa, dat_avaliacao, dimensao_avaliacao)
)
WITH (
    OIDS = FALSE
)
...
INSERT INTO public.indicadores_dimensao(
